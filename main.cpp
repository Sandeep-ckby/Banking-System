...
public:
    ...
    double fdrAmount;
    double dpsMonthly;
    double FDR_INTEREST = 0.08; // 8%
    double DPS_INTEREST = 0.06; // 6%
...
int main() {
    ...
    string defaultNames[10] = {
        "Abir Mollik", "Sandeep Chakraborty", "Sahadat Ali", "Abdul Kader", "Eusuf Khan",
        "Salman Khan", "Rabeya Akter", "Anubhab Ganguly", "Polash Saha", "Indubati"
    };
